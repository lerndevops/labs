...
## cd /tmp ; sudo wget https://downloads.apache.org/maven/maven-3/3.8.3/binaries/apache-maven-3.8.3-bin.tar.gz
cd /tmp ; sudo wget https://downloads.apache.org/maven/maven-3/3.8.3/binaries/apache-maven-3.8.4-bin.tar.gz
...
echo "MAVEN_HOME=/opt/apache-maven-3.8.4" >> /etc/profile
